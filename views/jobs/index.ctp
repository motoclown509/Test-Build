<div class="jobs index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $job['Vehicle']['year'] .' '. $job['Vehicle']['model'] .' ('. $job['Vehicle']['color'] .')'; ?></td>
		<td><?php echo $job['Job']['name']; ?>&nbsp;</td>
		<td><?php echo $job['Job']['description']; ?>&nbsp;</td>
		<td><?php echo $job['Job']['hours']; ?>&nbsp;</td>
		<td><?php echo $job['Job']['miles']; ?>&nbsp;</td>
		<td><?php echo date('m/d/Y g:i a', strtotime($job['Job']['created'])); ?>&nbsp;</td>
		<td><?php echo date('m/d/Y g:i a', strtotime($job['Job']['modified'])); ?>&nbsp;</td>
		<td class="actions">
